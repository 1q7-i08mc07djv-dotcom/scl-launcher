...
const ICONS = {
  ...
  settings: 'M940.4 463.7L773.3 174.2c-17.3-30-49.2-48.4-83.8-48.4H340.2c-34.6 0-66.5 18.5-83.8 48.4L89.2 463.7c-17.3 30-17.3 66.9 0 96.8L256.4 850c17.3 30 49.2 48.4 83.8 48.4h349.2c34.6 0 66.5-18.5 83.8-48.4l167.2-289.5c17.3-29.9 17.3-66.8 0-96.8z m-94.6 96.8L725.9 768.1c-17.3 30-49.2 48.4-83.8 48.4H387.5c-34.6 0-66.5-18.5-83.8-48.4L183.9 560.5c-17.3-30-17.3-66.9 0-96.8l119.8-207.5c17.3-30 49.2-48.4 83.8-48.4h254.6c34.6 0 66.5 18.5 83.8 48.4l119.8 207.5c17.3 30 17.3 66.9 0.1 96.8z',
...
export default function MainLayout({ children }: MainLayoutProps) {
  ...
  return (
    ...
    >
      ...
      {/* Main window container with rounded border */}
      <div
        className="absolute inset-2 rounded pcl-shadow"
        style={{ backgroundColor: '#1A1A1A' }}
      >
        {/* Title bar */}
        <div
          className="title-bar flex items-center justify-between px-4"
          style={{ height: 48, backgroundColor: '#2D2D2D' }}
        >
          {/* Left: Logo + CE badge */}
          ...
          {/* Right: Spacer + version */}
          <div className="flex items-center gap-2">
            <span className="text-white/40 text-xs">{version}</span>
            {/* Window controls */}
            <MyIconButton
              logo={ICONS.minimize}
              theme="white"
        ...
        >
          {/* Left sidebar (page-specific, shown as needed) */}
          <div
            id="left-panel"
