...
一个现代化的 Minecraft 启动器，基于 PCL 社区版设计，使用前后端分离架构。
...
SCL 启动器界面采用深色主题，设计风格参考自 PCL 社区版（Plain Craft Launcher CE），支持中英文切换。
...
- ⚡ **多镜像加速** — BMCLAPI、阿里云、腾讯云、GitCode 等下载源
